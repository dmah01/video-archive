...
>
                ...
                <div className="mb-2 rounded-xl border border-zinc-800 bg-zinc-900/70 p-1 sm:mb-3">
                  <p className="px-2 pb-1.5 pt-1 text-[9px] font-medium text-zinc-600">검색 조건</p>
                  <div className="grid grid-cols-3 gap-1">
                    {([
                      ...
                      <button
                        ...
                        className={`rounded-lg px-2 py-2 text-[10px] transition sm:text-[11px] ${
